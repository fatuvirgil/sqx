...
impl Default for SchemaEnumerationConfig {
    fn default() -> Self {
        Self {
            ...
            max_name_length: 64,
            column_wordlist: DEFAULT_COLUMN_WORDLIST.iter().map(|s| s.to_string()).collect(),
        }
    }
}
...
pub const DEFAULT_COLUMN_WORDLIST: &[&str] = &[
    "id", "uuid", "guid", "pk", "sk",
    "username", "user", "user_name", "login", "email", "e_mail", "mail",
    "password", "pass", "passwd", "pwd", "pass_hash", "password_hash",
    "name", "first_name", "last_name", "fullname", "full_name", "surname", "given_name",
    "phone", "phone_number", "mobile", "cell", "fax", "telephone",
    "address", "street", "city", "state", "zip", "zipcode", "postal_code", "country", "region",
    "age", "dob", "date_of_birth", "birthdate", "birth_date", "gender", "sex",
    "title", "job_title", "position", "department", "company", "organization", "org",
    "role", "group", "level", "rank", "status", "active", "enabled", "disabled", "banned",
    "avatar", "image", "photo", "profile_pic", "picture",
    "bio", "description", "summary", "about", "notes", "comment", "comments",
    "created_at", "created_on", "create_date", "creation_date", "date_created",
    "updated_at", "updated_on", "update_date", "last_updated", "modified_at", "timestamp",
    "deleted_at", "removed_at", "archived_at",
    "token", "api_token", "access_token", "refresh_token", "auth_token", "verify_token",
    "secret", "api_secret", "client_secret", "app_secret", "consumer_secret",
    "key", "api_key", "public_key", "private_key", "client_key", "consumer_key",
    "session", "session_id", "sessid", "sid", "phpsessid", "asp_session",
    "cookie", "cookie_id", "tracking_id", "visitor_id", "analytics_id",
    "ip", "ip_address", "last_ip", "remote_addr", "user_agent", "ua", "browser",
    "url", "link", "redirect", "return_url", "callback", "next", "referer", "referrer",
    "type", "kind", "category", "cat", "tag", "tags", "label", "labels",
    "code", "country_code", "lang", "language", "locale", "currency", "ccy",
    "price", "cost", "amount", "total", "subtotal", "discount", "tax", "fee",
    "quantity", "qty", "count", "cnt", "num", "number", "size", "weight", "volume",
    "score", "points", "rating", "rank", "priority", "order", "sort", "position", "seq",
    "content", "body", "text", "message", "msg", "subject", "topic", "thread",
    "data", "value", "val", "v", "meta", "metadata", "extra", "options", "settings",
    "config", "configuration", "prefs", "preferences", "params", "parameters", "args",
    "file", "filename", "file_name", "path", "filepath", "file_path", "dir", "directory",
    "ext", "extension", "mime", "mimetype", "mime_type", "content_type", "format",
    "hash", "checksum", "md5", "sha1", "sha256",
    "version", "ver", "revision", "rev", "build", "release", "edition",
    "owner", "owner_id", "user_id", "admin_id", "manager_id", "parent_id", "child_id",
    "account", "account_id", "account_number", "acc_num", "iban", "swift", "routing",
    "card", "card_num", "card_number", "cc_num", "cc_number", "cvv", "cvv2", "expiry",
    "balance", "credit", "debit", "deposit", "withdrawal", "transaction_id", "txn_id",
    "product", "product_id", "item", "item_id", "sku", "upc", "ean", "isbn",
    "order_id", "invoice_id", "payment_id", "subscription_id", "plan_id", "project_id",
    "page", "page_id", "post_id", "article_id", "blog_id", "forum_id", "thread_id",
    "status_id", "state_id", "type_id", "category_id", "role_id", "group_id",
];
